...
const App: React.FC = () => {
  ...
  const handleExportPng = async () => {
    ...
    // CRITICAL: Ensure all fonts are ready and loaded into the capture environment.
    // We use document.fonts.ready and a mandatory delay for complete font painting.
    try {
